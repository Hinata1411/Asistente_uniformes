  ...
  const handleGenerateAI = async () => {
    try {
      if (
        ...
        alert('Selecciona producto, talla, técnica, cantidad y lado de personalización')
        return
      }
  ...
  return (
    <div className="container mt-4">
      ...
      <div className="card p-3 mb-3">
        ...
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            >
              <option value="">Seleccione</option>
              {selectedProduct?.allowedTechniques.map((technique) => (
        ...
        <div className="row mt-3">
          <div className="col-md-4">
            <label>Parte a personalizar</label>
            <select
              className="form-control"
              value={form.customizationSide}
              disabled={!selectedProduct}
              onChange={(e) => {
                setForm({ ...form, customizationSide: e.target.value })
                setAiResult(null)
                setPreviewBase64('')
              }}
            >
        ...
        <button
          ...
          disabled={loadingAI}
        >
          {loadingAI ? 'Validando con IA...' : 'Validar pedido con IA'}
        </button>
      </div>
        ...
        <div className="card mt-3 shadow-sm border-0">
          ...
          <div className="card-body text-start">
            <p>
              ...
              >
                {aiResult.riskLevel || 'No definido'}
              </span>
            </p>

            <p>
              <strong>Compatibilidad de técnica:</strong>{' '}
            ...
            <strong>Tamaños recomendados por elemento:</strong>
            <ul>
            ...
            <p>
              <strong>Colores a utilizar:</strong>{' '}
            ...
            <strong>Elementos personalizados detectados:</strong>
            <ul>
              {aiResult.customElementsDetected?.length > 0 ? (
                aiResult.customElementsDetected.map((item, index) => (
                  <li key={index}>{item}</li>
                ))
              ) : (
                <li>Sin elementos detectados</li>
              )}
            </ul>
      ...
      <GarmentEditor
        ...
        customizationSide={form.customizationSide}
        onPreviewChange={(base64) => setPreviewBase64(base64)}
        onElementsChange={(elements) => setEditorElements(elements)}
